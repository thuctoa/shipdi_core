...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public static function findIdentityByAccessToken($token, $type = null)
    {
        ...
        {
            return static::findByUsername('admin');
        }
        return null;
    }
    ...
    public static function AuthenticateCode($authCode)
    {
        ...
        Yii::info('Get token raw response: '.$raw_response,'admin');
        ...
        {
            \Yii::error('Get Token error: '.$response["error"],'admin');
            return false;
        }
        ...
        $raw_response = curl_exec($ch);
        \Yii::info('Raw response: '.$raw_response,'admin');
        if ( $raw_response == false )
        {
            \Yii::info('Raw response is false','admin');
            return false;
        }
        ...
        {
            \Yii::error('Token info error: '.$person["error"],'admin');
            return false;
        }
        ...
        \Yii::info('Email: '.$firstEmail,'admin');
        
        return $firstEmail == "thucfami@gmail.com";
    }
